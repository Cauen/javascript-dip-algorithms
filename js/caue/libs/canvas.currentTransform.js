...
(function() {
	...
	*/
	if (!('currentTransform' in contextProto) || !('currentTransformInverse' in contextProto)) {
		...
		contextProto.saveCaue = function() {
		...
		contextProto.restoreCaue = function() {
		...
		contextProto.scaleCaue = function(x, y) {
		...
		contextProto.rotateCaue = function(angle) {
		...
		contextProto.transformCaue = function(a, b, c, d, e, f) {
			this._transformMatrix = [
		...
		contextProto.setTransformCaue = function(a, b, c, d, e, f) {
			this._transformMatrix = [ a, b, c, d, e, f];
			return originalSetTransform.apply(this, Array.prototype.slice.call(arguments, 0));
		};
		contextProto.resetTransformCaue = function() {
