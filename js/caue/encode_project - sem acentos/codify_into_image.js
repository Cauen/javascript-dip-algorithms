...
var myRandomAscii = ["", "p", "q", "7", "#", "z", ":", "Ê", "?", "ú", "@", "j", "È", "T", "D", "Z", "í", "/", "á", "F", "(", "Ó", "X", "U", "M", ",", "Ç", "<", "Ô", "5", " ", "y", "ó", "â", "l", "Ú", "W", "[", "{", "1", "S", "ô", "s", ">", "f", "3", "ª", "P", "_", "-", "a", "o", "À", "L", "}", "ê", "'", "Q", "R", "Á", "N", "C", "~", "k", ".", "$", "^", "G", "e", "\"", "Y", "9", ")", "ã", "|", "g", "2", "*", "6", "w", "i", "n", "A", "]", "ç", "0", "!", "t", "u", "v", "%", "O", "8", "d", "H", "é", "Â", "E", "h", "\\", "°", "è", "É", "Í", "x", "4", "b", "V", "c", "B", "&", "m", "à", "J", "I", "+", "K", "=", "Ã", "r", ";", "`"];
...
function generateCodedImage(text) {
	...
	pixelArray.splice(0, 0, [sumToR + 31,sumToG + 31,sumToB + 31,255]);
